...
`)])),_:1},8,["dark"])]),default:n(()=>[o(i(h),{class:"ex--custom-events-count","selected-date":i(H)("2018-11-19"),"time-from":10*60,"time-step":2*60,"date-picker":"","events-count-on-year-view":"",dark:i(r).darkMode,events:x},{"events-count":n(({events:s,view:f})=>[j(s)?(g(),w("span",oe,d(j(s)),1)):B("",!0)]),_:1},8,["selected-date","dark"])]),_:1}),o(M,{title:"Custom Title & Cells",anchor:"custom-title-and-cells"},{desc:n(()=>[o(y,{tip:""},{default:n(()=>[e[50]||(e[50]=l("Using Vue.js scoped slots, you can override the calendar main date title and calendar cells.")),e[51]||(e[51]=t("br",null,null,-1)),e[52]||(e[52]=l(`
If you are not familiar with scoped slots and destructuring slot-scope, you should first read about it:
...
</vue-cal>`)])),desc2:n(()=>e[81]||(e[81]=[])),default:n(()=>[o(i(h),{class:"ex--custom-title-and-cells",dark:i(r).darkMode,time:!1,"dblclick-to-navigate":!1,view:"month",events:x},{title:n(s=>[e[82]||(e[82]=l("🎉 ")),s.id==="years"?(g(),w("span",re,"Years")):s.id==="year"?(g(),w("span",ue,d(s.start.format("YYYY")),1)):s.id==="month"?(g(),w("span",me,d(s.start.format("MMMM YYYY")),1)):s.id==="week"?(g(),w("span",ve,"w"+d(s.start.getWeek())+" ("+d(s.start.format("MMM YYYY"))+")",1)):s.id==="days"?(g(),w("span",pe,d(s.start.format("D MMMM YYYY"))+" - "+d(s.end.format("D MMMM YYYY")),1)):s.id==="day"?(g(),w("span",ce,d(s.start.format("dddd D MMMM YYYY")),1)):B("",!0),e[83]||(e[83]=l(" 🎉"))]),_:1},8,["dark"])]),_:1}),o(M,{title:"Custom event Rendering",anchor:"custom-event-rendering"},{desc:n(()=>[e[95]||(e[95]=t("p",{class:"mb2"},"Using Vue.js scoped slots, you can override the events rendering.",-1)),o(y,{class:"my2",tip:""},{default:n(()=>[e[86]||(e[86]=l(`If you are not familiar with scoped slots and destructuring slot-scope, you should first read about it:
