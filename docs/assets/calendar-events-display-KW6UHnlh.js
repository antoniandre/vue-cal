...
`,-1))])]),_:1}),l(f,{title:"Events & Background Events",anchor:"events"},{desc:s(()=>[e[26]||(e[26]=n("p",null,[t("Events are defined by a "),n("code",null,"start"),t(" and "),n("code",null,"end"),t(` dates, provided as a JavaScript Date object
...
`)])],-1)),n("div",q,[l(b,{modelValue:D.showBgEvents,"onUpdate:modelValue":e[0]||(e[0]=o=>D.showBgEvents=o)},{default:s(()=>e[25]||(e[25]=[t("Show Background Events")])),_:1},8,["modelValue"])])]),"code-html":s(()=>e[28]||(e[28]=[t('<vue-cal :events="events" />')])),"code-js":s(()=>[e[29]||(e[29]=t(`const events = [
  {
...
resized.`)],-1)])),"code-html":s(()=>e[32]||(e[32]=[t('<vue-cal :time="false" :events="events" />')])),"code-js":s(()=>e[33]||(e[33]=[t(`const events = [
  ...
  ...
]`)])),default:s(()=>[l(d(E),{dark:d(h).darkMode,time:!1,views:{days:{cols:5,rows:1}},view:"days","views-bar":!1,events:B.events},null,8,["dark","events"])]),_:1}),l(f,{title:"Open a Dialog on Event Click",anchor:"open-dialog-on-event-click"},{desc:s(()=>e[34]||(e[34]=[n("p",{class:"mb2"},[t(`You can attach whatever event listener you want to the events: it only needs to start with
...
`)])),default:s(()=>[l(d(E),{class:"ex--open-dialog-on-event-click",events:c.events,"time-from":9*60,"time-to":15*60,views:{days:{cols:5,rows:1}},view:"days","views-bar":!1,dark:d(h).darkMode,onEventClick:c.openDialog},null,8,["events","dark","onEventClick"])]),_:1}),c.event?(r(),N(M,{key:0,modelValue:c.showDialog,"onUpdate:modelValue":e[2]||(e[2]=o=>c.showDialog=o),title:c.event.title,width:"380"},{default:s(()=>[n("div",I,[l(O,{class:"grey"},{default:s(()=>e[37]||(e[37]=[t("mdi mdi-calendar")])),_:1}),n("small",null,i(c.event.start.format()),1),l(O,{class:"grey ml2"},{default:s(()=>e[38]||(e[38]=[t("mdi mdi-clock-outline")])),_:1}),n("small",null,i(c.event.start.formatTime())+" - "+i(c.event.end.formatTime()),1)]),n("div",{class:"w-flex align-center justify-center title1 mt6 mb4",innerHTML:c.event.content},null,8,L),e[39]||(e[39]=n("p",{class:"lh1"},`Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil inventore expedita veniam deleniti,
labore corporis quas, aspernatur praesentium quia nisi, omnis quod autem.
`,-1))]),_:1},8,["modelValue","title"])):A("",!0),l(f,{title:"Month View Events & Count",anchor:"events-on-month-view"},{desc:s(()=>[n("ul",null,[e[43]||(e[43]=n("li",null,[t("When "),n("code",null,"events-on-month-view"),t(` is set to true, the events will show in full on the month view
...
`)),l(j,{to:"/examples/customization#ex--events-on-month-view"},{default:s(()=>e[40]||(e[40]=[t("Events on Month View Customization")])),_:1}),e[42]||(e[42]=t(`.
`))])]),n("div",Y,[l(b,{modelValue:a.showEvents,"onUpdate:modelValue":[e[3]||(e[3]=o=>a.showEvents=o),e[4]||(e[4]=o=>a.showEvents&&(a.showEventCount=!1))],"label-on-left":""},{default:s(()=>e[46]||(e[46]=[t("Show Events")])),_:1},8,["modelValue"]),l(b,{modelValue:a.showEventCount,"onUpdate:modelValue":[e[5]||(e[5]=o=>a.showEventCount=o),e[6]||(e[6]=o=>a.showEventCount&&(a.showEvents=!1))],"label-on-left":""},{default:s(()=>e[47]||(e[47]=[t("Show Event Count")])),_:1},8,["modelValue"]),l(T,{modelValue:a.eventCountStyle,"onUpdate:modelValue":e[7]||(e[7]=o=>a.eventCountStyle=o),inline:"",items:a.eventCountStyleOptions,disabled:!a.showEventCount},{default:s(()=>e[48]||(e[48]=[t("Events Count Style")])),_:1},8,["modelValue","items","disabled"]),e[50]||(e[50]=n("p",{class:"caption"},"For illustration, the slot option will only count orange events (with the `leisure` class).",-1)),l(b,{modelValue:a.highlightCells,"onUpdate:modelValue":e[8]||(e[8]=o=>a.highlightCells=o),"label-on-left":""},{default:s(()=>e[49]||(e[49]=[t("Highlight Cells with Events")])),_:1},8,["modelValue"])])]),"code-html":s(()=>[t(`<vue-cal
...
`)),a.showEventCount?a.eventCountStyle==="dot"?(r(),v(p,{key:1},[t(`  .event-count--dot .vuecal__cell-events-count {
    position: absolute;
    bottom: 14px;
    right: 15%;
...
`,1)],64)):(r(),v(p,{key:6},[],64)),e[52]||(e[52]=t("}"))]),default:s(()=>[l(d(E),{events:C,"events-on-month-view":a.showEvents,"event-count":a.showEventCount,"time-from":8*60,"time-to":18*60,views:{days:{cols:5,rows:1},month:{},year:{}},view:"month",dark:d(h).darkMode,class:W(a.classes),style:{height:"506px"}},F({_:2},[a.showEventCount&&a.eventCountStyle==="slot"?{name:"event-count",fn:s(({events:o})=>[o.filter(H=>H.class==="leisure").length?(r(),v("span",$,i(o.filter(H=>H.class==="leisure").length),1)):A("",!0)]),key:"0"}:void 0]),1032,["events-on-month-view","event-count","dark","class"])]),_:1}),l(f,{title:"Overlapping Events",anchor:"overlapping-events"},{desc:s(()=>[e[55]||(e[55]=n("p",null,[t("Overlapping, editable & deletable events."),n("br"),t(`
...
Example of classes for three overlapping events: `),n("code",null,"vuecal__event--stack-1-3"),t(", "),n("code",null,"vuecal__event--stack-2-3"),t(", "),n("code",null,"vuecal__event--stack-3-3"),t(".")],-1)),l(z,{src:"/images/calendar-events-display-overlapping-events.webp",lazy:"","aspect-ratio":1076/336,"max-width":"500px"})]),_:1}),n("div",R,[l(b,{modelValue:k.stackEvents,"onUpdate:modelValue":e[9]||(e[9]=o=>k.stackEvents=o),"label-on-left":""},{default:s(()=>e[54]||(e[54]=[t("Stack Events")])),_:1},8,["modelValue"])])]),"code-html":s(()=>[t(`<vue-cal
...
`)])),default:s(()=>[l(d(E),{events:k.events,"editable-events":"","stack-events":k.stackEvents,"min-event-width":k.minEventWidth,views:{days:{cols:5,rows:1}},view:"days","views-bar":!1,"time-from":9*60,"time-to":15*60,dark:d(h).darkMode},null,8,["events","stack-events","min-event-width","dark"])]),_:1}),l(f,{title:"All Day Events",anchor:"all-day-events"},{desc:s(()=>[e[59]||(e[59]=n("p",null,[t(`All-day events are events that span the whole day (from 00:00 to 23:59:59:999). They will be displayed in a fixed top bar
...
`)])),default:s(()=>[l(d(E),{"time-from":7*60,view:"days",views:{day:{},days:{cols:5,rows:1},week:{},month:{}},"all-day-events":m.allDayBarOn,events:m.events,dark:d(h).darkMode},null,8,["all-day-events","events","dark"])]),_:1}),l(f,{title:"Multiple Day Events",anchor:"multiple-day-events"},{title:s(()=>e[64]||(e[64]=[t("Multiple Day Events"),n("div",{class:"todo-tag prod d-iflex ml2"},"COMING SOON",-1)])),_:1}),l(f,{anchor:"recurring-events"},{title:s(()=>e[65]||(e[65]=[t("Recurring Events"),n("div",{class:"todo-tag prod d-iflex ml2"},"COMING SOON",-1)])),_:1})],64)}}};export{_ as default};
