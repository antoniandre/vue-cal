...
`)],64))]),default:l(()=>[o(g(V),{events:w.events,"editable-events":{drag:w.draggableEvents},onEventDrop:w.onEventDrop,schedules:[{id:1,label:"Dr 1"},{id:2,label:"Dr 2"}],"time-from":9*60,"time-to":15*60,"snap-to-interval":w.snapToInterval?60:0,views:{days:{cols:5,rows:1}},view:"days","views-bar":!1,dark:g(h).darkMode,class:te({"override-drag-css":w.overrideDragCss}),style:{height:"312px"}},null,8,["events","editable-events","onEventDrop","snap-to-interval","dark","class"])]),_:2},[w.overrideDragCss?{name:"code-css",fn:l(()=>[e[122]||(e[122]=n(`.vuecal__event--dragging-ghost {
  opacity: 1;
...
`,-1)),t("div",Be,[o(b,{modelValue:y.preventOverlapOnDrop,"onUpdate:modelValue":e[28]||(e[28]=a=>y.preventOverlapOnDrop=a),"label-color":"base"},{default:l(()=>e[129]||(e[129]=[n("Prevent Event Overlap On Drop")])),_:1},8,["modelValue"]),o(b,{modelValue:y.preventOverlapWhileResizing,"onUpdate:modelValue":e[29]||(e[29]=a=>y.preventOverlapWhileResizing=a),"label-color":"base"},{default:l(()=>e[130]||(e[130]=[n("Prevent Overlap WHILE Resizing")])),_:1},8,["modelValue"]),o(b,{modelValue:y.preventOverlapAfterResizing,"onUpdate:modelValue":e[30]||(e[30]=a=>y.preventOverlapAfterResizing=a),"label-color":"base"},{default:l(()=>e[131]||(e[131]=[n("Prevent Overlap AFTER Resizing")])),_:1},8,["modelValue"])])]),"code-html":l(()=>e[134]||(e[134]=[n(`<vue-cal
  :events="events"
  editable-events
  @event-drop="onEventDrop"
