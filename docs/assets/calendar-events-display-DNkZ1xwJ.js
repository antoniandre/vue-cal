...
`)),p.showBgEvents?(d(),u("span",F,`  {
    start: new Date(new Date().setHours(12, 0, 0, 0)),
    end: new Date(new Date().setHours(14, 0, 0, 0)),
    class: 'lunch',
    background: true // Background event.
  },
`)):(d(),u("span",q)),e[28]||(e[28]=t(`  ...
...
`)])),default:s(()=>[a(v(E),{class:"ex--open-dialog-on-event-click",events:c.events,"time-from":9*60,"time-to":15*60,views:{days:{cols:5,rows:1}},view:"days","views-bar":!1,dark:v(y).darkMode,onEventClick:c.openDialog,style:{height:"301px"}},null,8,["events","dark","onEventClick"])]),_:1}),c.event?(d(),N(B,{key:0,modelValue:c.showDialog,"onUpdate:modelValue":e[2]||(e[2]=o=>c.showDialog=o),title:c.event.title,width:"380"},{default:s(()=>[n("div",J,[a(H,{class:"grey"},{default:s(()=>e[35]||(e[35]=[t("mdi mdi-calendar")])),_:1}),n("small",null,i(c.event.start.format()),1),a(H,{class:"grey ml2"},{default:s(()=>e[36]||(e[36]=[t("mdi mdi-clock-outline")])),_:1}),n("small",null,i(c.event.start.formatTime())+" - "+i(c.event.end.formatTime()),1)]),n("div",{class:"w-flex align-center justify-center title1 mt6 mb4",innerHTML:c.event.content},null,8,G),e[37]||(e[37]=n("p",{class:"lh1"},`Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil inventore expedita veniam deleniti,
labore corporis quas, aspernatur praesentium quia nisi, omnis quod autem.
`,-1))]),_:1},8,["modelValue","title"])):M("",!0),a(h,{title:"Month View Events & Count",anchor:"events-on-month-view"},{desc:s(()=>[n("ul",null,[e[41]||(e[41]=n("li",null,[t("When "),n("code",null,"events-on-month-view"),t(` is set to true, the events will show in full on the month view
(you can customize via CSS or `),n("code",null,"#event"),t(" slots).")],-1)),e[42]||(e[42]=n("li",null,[t("When "),n("code",null,"event-count"),t(` is set to true, the events count will be shown on every cell that has
events (you can customize via CSS or via the `),n("code",null,"#event-count"),t(` slots). In this example you will
see 3 different (random) options that you can achieve with CSS.`)],-1)),e[43]||(e[43]=n("li",null,[t("For more precision, the "),n("code",null,"event-count"),t(` prop can also be set to an array of views to show the
count in. E.g. `),n("code",null,`:event-count="['month', 'year']"`)],-1)),n("li",null,[e[39]||(e[39]=t(`You can further customize the events display on month view by using a bit of CSS like in this example:
`)),a(O,{to:"/examples/customization#ex--events-on-month-view"},{default:s(()=>e[38]||(e[38]=[t("Events on Month View Customization")])),_:1}),e[40]||(e[40]=t(`.
`))])]),n("div",I,[a(k,{modelValue:l.showEvents,"onUpdate:modelValue":[e[3]||(e[3]=o=>l.showEvents=o),e[4]||(e[4]=o=>l.showEvents&&(l.showEventCount=!1))],"label-on-left":""},{default:s(()=>e[44]||(e[44]=[t("Show Events")])),_:1},8,["modelValue"]),a(k,{modelValue:l.showEventCount,"onUpdate:modelValue":[e[5]||(e[5]=o=>l.showEventCount=o),e[6]||(e[6]=o=>l.showEventCount&&(l.showEvents=!1))],"label-on-left":""},{default:s(()=>e[45]||(e[45]=[t("Show Event Count")])),_:1},8,["modelValue"]),a(j,{modelValue:l.eventCountStyle,"onUpdate:modelValue":e[7]||(e[7]=o=>l.eventCountStyle=o),inline:"",items:l.eventCountStyleOptions,disabled:!l.showEventCount},{default:s(()=>e[46]||(e[46]=[t("Events Count Style")])),_:1},8,["modelValue","items","disabled"]),e[48]||(e[48]=n("p",{class:"caption"},"For illustration, the slot option will only count orange events (with the `leisure` class).",-1)),a(k,{modelValue:l.highlightCells,"onUpdate:modelValue":e[8]||(e[8]=o=>l.highlightCells=o),"label-on-left":""},{default:s(()=>e[47]||(e[47]=[t("Highlight Cells with Events")])),_:1},8,["modelValue"])])]),"code-html":s(()=>[t(`<vue-cal
...
`,1),l.showEventCount&&l.eventCountStyle==="slot"?(d(),u(w,{key:0},[t(`
...
</template>`)],64)):(d(),u(w,{key:1},[],64))]),"code-css":s(()=>[e[49]||(e[49]=t(`.vuecal {
  height: 441px;
...
`)),l.showEventCount?l.eventCountStyle==="dot"?(d(),u(w,{key:1},[t(`  .event-count--dot .vuecal__cell-events-count {
    position: absolute;
    bottom: 14px;
    right: 15%;
...
`)],64)):l.eventCountStyle==="dash"?(d(),u(w,{key:2},[t(`  .event-count--dash .vuecal__cell-events-count {
    position: absolute;
    top: 24px;
    right: 12px;
    text-align: center;
...
`)],64)):l.eventCountStyle==="caption"?(d(),u(w,{key:3},[t(`  .event-count--caption .vuecal__cell-events-count {
    position: absolute;
    inset: auto 2px 2px;
    text-align: center;
    opacity: 0.3;
...
`)],64)):(d(),u(w,{key:4},[],64)):(d(),u(w,{key:0},[],64)),l.highlightCells?(d(),u(w,{key:5},[t("  .vuecal__cell--has-events {background-color: "+i(v(y).darkMode?"#00dbff1c":"#fffacda8")+`;}
`,1)],64)):(d(),u(w,{key:6},[],64)),e[50]||(e[50]=t("}"))]),default:s(()=>[a(v(E),{events:C,"events-on-month-view":l.showEvents,"event-count":l.showEventCount,"time-from":8*60,"time-to":18*60,views:{days:{cols:5,rows:1},month:{},year:{}},view:"month",dark:v(y).darkMode,class:U(l.classes)},z({_:2},[l.showEventCount&&l.eventCountStyle==="slot"?{name:"event-count",fn:s(({events:o})=>[o.filter(S=>S.class==="leisure").length?(d(),u("span",L,i(o.filter(S=>S.class==="leisure").length),1)):M("",!0)]),key:"0"}:void 0]),1032,["events-on-month-view","event-count","dark","class"])]),_:1}),a(h,{title:"Overlapping Events",anchor:"overlapping-events"},{desc:s(()=>[e[53]||(e[53]=n("p",null,[t("Overlapping, editable & deletable events."),n("br"),t(`
...
`)],-1)),n("div",$,[a(k,{modelValue:g.stackEvents,"onUpdate:modelValue":e[9]||(e[9]=o=>g.stackEvents=o),"label-on-left":""},{default:s(()=>e[51]||(e[51]=[t("Stack Events")])),_:1},8,["modelValue"])]),a(b,{class:"mb6",tip:""},{default:s(()=>e[52]||(e[52]=[t(`Alternatively, you can use the event stacking class (based on the stack position and length) to override
...
Example of classes for three overlapping events: `),n("code",null,"vuecal__event--stack-1-3",-1),t(", "),n("code",null,"vuecal__event--stack-2-3",-1),t(", "),n("code",null,"vuecal__event--stack-3-3",-1),t(".")])),_:1})]),"code-html":s(()=>[t(`<vue-cal
  ...
  :events="events">
</vue-cal>`,1)]),"code-js":s(()=>e[54]||(e[54]=[t(`data: () => ({
  minEventWidth: 0,
  events: [
    {
...
`)])),default:s(()=>[a(v(E),{events:g.events,"editable-events":"","stack-events":g.stackEvents,"min-event-width":g.minEventWidth,views:{days:{cols:5,rows:1}},view:"days","views-bar":!1,"time-from":9*60,"time-to":15*60,dark:v(y).darkMode,style:{height:"301px"}},null,8,["events","stack-events","min-event-width","dark"])]),_:1}),a(h,{title:"All Day Events",anchor:"all-day-events"},{title:s(()=>e[55]||(e[55]=[t("All Day Events"),n("div",{class:"todo-tag prod d-iflex ml2"},"COMING SOON",-1)])),_:1}),a(h,{title:"Multiple Day Events",anchor:"multiple-day-events"},{title:s(()=>e[56]||(e[56]=[t("Multiple Day Events"),n("div",{class:"todo-tag prod d-iflex ml2"},"COMING SOON",-1)])),_:1}),a(h,{anchor:"recurring-events"},{title:s(()=>e[57]||(e[57]=[t("Recurring Events"),n("div",{class:"todo-tag prod d-iflex ml2"},"COMING SOON",-1)])),_:1})],64)}}};export{P as default};
