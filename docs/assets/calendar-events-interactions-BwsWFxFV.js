...
`)])),_:1}),t("div",xe,[o(b,{modelValue:w.creatable,"onUpdate:modelValue":e[14]||(e[14]=a=>w.creatable=a)},{default:l(()=>e[91]||(e[91]=[n("Create Events")])),_:1},8,["modelValue"]),o(b,{modelValue:w.resizable,"onUpdate:modelValue":e[15]||(e[15]=a=>w.resizable=a)},{default:l(()=>e[92]||(e[92]=[n("Resize Events")])),_:1},8,["modelValue"]),o(b,{modelValue:w.draggable,"onUpdate:modelValue":e[16]||(e[16]=a=>w.draggable=a)},{default:l(()=>e[93]||(e[93]=[n("Drag Events")])),_:1},8,["modelValue"]),o(b,{modelValue:w.deletable,"onUpdate:modelValue":e[17]||(e[17]=a=>w.deletable=a)},{default:l(()=>e[94]||(e[94]=[n("Delete Events")])),_:1},8,["modelValue"])])]),"code-html":l(()=>[n(`<vue-cal
...
`)],64))]),default:l(()=>[o(g(V),{events:f.events,"editable-events":{drag:f.draggableEvents},onEventDrop:f.onEventDrop,schedules:[{id:1,label:"Dr 1"},{id:2,label:"Dr 2"}],"time-from":9*60,"time-to":15*60,"snap-to-interval":f.snapToInterval?60:0,views:{days:{cols:5,rows:1}},view:"days","views-bar":!1,dark:g(h).darkMode,class:ne({"override-drag-css":f.overrideDragCss}),style:{height:"312px"}},null,8,["events","editable-events","onEventDrop","snap-to-interval","dark","class"])]),_:2},[f.overrideDragCss?{name:"code-css",fn:l(()=>[e[123]||(e[123]=n(`.vuecal__event--dragging-ghost {
  opacity: 1;
