import{u as M,r as y,b as A,e,f as s,w as n,h as l,a as p,t as r,g as a,l as E,F as C,d as I}from"./index-CjRCtfaS.js";import{b as z}from"./index-DEtHqn4A.js";const O={class:"w-flex justify-space-between mb2"},V={class:"code"},F={class:"w-flex justify-space-between mb2"},B={class:"w-flex justify-space-between mb2"},N={class:"w-flex justify-space-between mb2"},R={class:"code"},W={class:"mt2"},Y={class:"w-flex justify-space-between mb2"},U={class:"w-flex justify-space-between mb2"},Z={__name:"api",setup(J){z();const i=M(),h=E("locales"),b=[{label:"day",content:"Displays a given single day in a a single cell."},{label:"days",content:"Displays a given custom unlimited range of days, from 1 to x. Be aware that the more days displayed, the heavier work for the calendar and consumed API."},{label:"week",content:"Displays a given 7-day week in 7 cells by default and at most, starting from Monday by default.<br>Other options can modify the order or number of days."},{label:"month",content:"Displays a given month in a 6x7 cell grid by default and at most."},{label:"year",content:"Displays a given year's months in a 4x3 cell grid. Usually for a date picker.<br>No event can be displayed on this view by default - only events counter - but you could use slots to build a custom UI."},{label:"years",content:"Displays a range of 25 years in a 5x5 cell grid. Usually for date pickers."}],c=y([...b].fill(!1)),w=y(Array(10).fill(!1)),k=y(Array(15).fill(!1)),T=y(Array(99).fill(!1)),D=y(Array(50).fill(!1)),x=y(Array(50).fill(!1));return(H,t)=>{const v=p("title-link"),g=p("w-switch"),m=p("w-accordion"),d=p("ssh-pre"),o=p("w-accordion-item"),j=p("w-tag"),S=p("router-link"),f=p("alert");return I(),A(C,null,[t[394]||(t[394]=e("h1",{class:"title1"},"API",-1)),e("h2",O,[s(v,{div:"",anchor:"views"},{default:n(()=>t[12]||(t[12]=[l("Calendar Views")])),_:1}),s(g,{class:"my1 body","onUpdate:modelValue":t[0]||(t[0]=u=>c.value=[...b].fill(u))},{default:n(()=>t[13]||(t[13]=[l("Expand All")])),_:1})]),s(m,{modelValue:c.value,"onUpdate:modelValue":t[1]||(t[1]=u=>c.value=u),items:b,"expand-icon-rotate90":"","title-class":"pl0 bd0","content-class":"pt0 pb3"},{"item-title":n(({item:u})=>[e("strong",V,r(u.label),1)]),_:1},8,["modelValue"]),e("h2",F,[s(v,{div:"",anchor:"view"},{default:n(()=>t[14]||(t[14]=[l("The View Object")])),_:1}),t[16]||(t[16]=e("div",{class:"todo-tag ml2 mra"},"TO REVIEW",-1)),s(g,{class:"my1 body","onUpdate:modelValue":t[2]||(t[2]=u=>w.value=Array(10).fill(u))},{default:n(()=>t[15]||(t[15]=[l("Expand All")])),_:1})]),t[395]||(t[395]=e("p",{class:"caption size--md lh1"},[l("You can use the "),e("code",{class:"base-color"},"view"),l(` object to access accurate information about the current view at any time.
...
`)])),_:1},8,["dark"])]),_:1})]),_:1},8,["modelValue"]),e("h2",N,[s(v,{div:"",anchor:"options"},{default:n(()=>t[82]||(t[82]=[l("Options")])),_:1}),t[84]||(t[84]=e("div",{class:"todo-tag ml2 mra"},"TO REVIEW",-1)),s(g,{class:"my1 body","onUpdate:modelValue":t[6]||(t[6]=u=>T.value=Array(99).fill(u))},{default:n(()=>t[83]||(t[83]=[l("Expand All")])),_:1})]),t[399]||(t[399]=e("p",{class:"caption size--md lh1"},[l("Options can be provided to <vue-cal> using a "),e("code",{class:"base-color"},'v-bind="configObject"'),l(" or added one by one."),e("br"),l(`
...
unless a distinction is needed. E.g. `),e("span",{class:"code"},"'pt-br'"),l(" for Portuguese-Brasilian.")],-1)),s(f,{info:""},{default:n(()=>[l("Currently available languages are "+r(a(h).map(u=>u.label).join(", "))+".",1),t[131]||(t[131]=e("br",null,null,-1)),t[132]||(t[132]=l(`
...
read on in the `)),s(S,{to:"/getting-started#css-notes"},{default:n(()=>t[150]||(t[150]=[l("CSS Notes")])),_:1}),t[158]||(t[158]=l(`.
