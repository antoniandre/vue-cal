...
in this logs box:`,-1)),e[56]||(e[56]=t("div",{class:"caption lh0 my1"},[l("The "),t("span",{class:"code"},"event-drag"),l(" event logging is disabled for performance reasons (too many events).")],-1)),t("div",F,[t("div",Y,[e[51]||(e[51]=t("div",{class:"grey"},[l("// "),t("strong",null,"event-name: "),t("span",null,"{ arguments }")],-1)),e[52]||(e[52]=t("div",{class:"spacer"},null,-1)),a(v,{class:"mt1 mr1",outline:"",sm:"",onClick:e[0]||(e[0]=n=>o.logMouseEvents=!o.logMouseEvents),tooltip:"Will also log events on<br><code>cell-mousemove</code>, <code>cell-mouseenter</code>, <code>cell-mouseleave</code>.","tooltip-props":{alignRight:!0}},{default:s(()=>[a(d,{class:"mr1"},{default:s(()=>[l("mdi mdi-"+f(o.logMouseEvents?"trash-can-outline":"plus"),1)]),_:1}),l(f(o.logMouseEvents?"remove":"Add")+" Mouse Move & Hover Events",1)]),_:1}),a(v,{class:"mt1",outline:"",sm:"",onClick:o.clearEventsLog},{default:s(()=>[a(d,{class:"mr1",xs:""},{default:s(()=>[...e[49]||(e[49]=[l("mdi mdi-trash-can-outline",-1)])]),_:1}),e[50]||(e[50]=l("Clear Logs",-1))]),_:1},8,["onClick"])]),a(T,{class:"ma0 py0 scrollable",ref_key:"logsBoxEl",ref:N,language:"js",dark:w(b).darkMode},{default:s(()=>[(x(!0),h(S,null,P(o.logs,(n,C)=>(x(),h("div",{class:"mt1",key:C},f(C?`
...
`,-1)])]),default:s(()=>[t("div",G,[a(w(M),{dark:w(b).darkMode,"time-from":540,"time-to":1080,"views-bar":!1,events:m.events,onReady:m.onReady,onViewChange:m.onViewChange,style:{height:"421px"}},null,8,["dark","events","onReady","onViewChange"]),m.loading?(x(),L(R,{key:0,class:"mt-1"})):U("",!0),t("div",q,[m.loading?(x(),h(S,{key:0},[l("Loading events...")],64)):(x(),h(S,{key:1},[l(f(m.eventsTotal)+" events loaded.",1)],64))])])]),_:1}),a(k,{title:"External Controls & use of Vue Cal Methods",anchor:"external-controls"},{desc:s(()=>{var n,C;return[e[79]||(e[79]=t("p",null,[l("You can access any "),t("strong",null,"Vue Cal"),l(" internal method through Vue refs."),t("br"),l(`
...
`,-1)])]),desc2:s(()=>[e[85]||(e[85]=t("h5",{class:"subtitle-1 font-weight-bold"},"Other useful Vue Cal internal methods & Date prototypes",-1)),a(c,{tip:""},{default:s(()=>[...e[84]||(e[84]=[l(`Along with these Vue Cal internal methods that you can use externally,
...
`)],-1)])]),_:1})]),_:1}),a(k,{title:"Sync Two Vue Cal Instances",anchor:"sync-two-calendars"},{desc:s(()=>[...e[86]||(e[86]=[t("p",null,[l(`In this example the right calendar is used as a date picker and the selected date is
...
`),t("a",{href:"#ex--emitted-events"},"emitted events example"),l(".")],-1)])]),"code-html":s(()=>[...e[87]||(e[87]=[l(`<vue-cal
  date-picker
  :views-bar="false"
  v-model:selected-date="selectedDate"
