...
`)])],-1)),o(j,{class:"bd1 bdrs2 sh2",src:`${K.value}images/click-and-drag.webp`,alt:"Create Events",width:"250",lazy:""},null,8,["src"])]),o(h,null,{default:l(()=>e[52]||(e[52]=[n("The event creation is only available on a day cell: not on year & years views.",-1)])),_:1,__:[52]}),t("div",ye,[e[54]||(e[54]=t("label",null,"Create Event On Cell",-1)),t("div",null,[o(O,{modelValue:s.createMethod,"onUpdate:modelValue":[e[0]||(e[0]=a=>s.createMethod=a),(S.value||{}).refreshHeight],items:s.createMethods},null,8,["modelValue","onUpdate:modelValue","items"]),e[53]||(e[53]=t("p",{class:"caption mt1"},"(Or however you want)",-1))])]),t("div",De,[o(b,{modelValue:s.skipCreationDialog,"onUpdate:modelValue":[e[1]||(e[1]=a=>s.skipCreationDialog=a),(S.value||{}).refreshHeight]},{default:l(()=>e[55]||(e[55]=[n("Skip Creation Dialog",-1)])),_:1,__:[55]},8,["modelValue","onUpdate:modelValue"]),o(b,{modelValue:s.snapToInterval,"onUpdate:modelValue":e[2]||(e[2]=a=>s.snapToInterval=a)},{default:l(()=>e[56]||(e[56]=[n("Snap to Interval: ",-1),t("span",{class:"code transparent--bg inherit"},"15min",-1)])),_:1,__:[56]},8,["modelValue"]),o(b,{modelValue:s.eventCreateMinDrag,"onUpdate:modelValue":e[3]||(e[3]=a=>s.eventCreateMinDrag=a)},{default:l(()=>e[57]||(e[57]=[n("Event Create Drag Min: ",-1),t("span",{class:"code transparent--bg inherit"},"15px",-1)])),_:1,__:[57]},8,["modelValue"])])]),"code-html":l(()=>[n(`<vue-cal
...
const validateCreation = () => {`,-1)),s.createMethod!=="event-create"?(i(),d(u,{key:2},[n(`
  ...
  showCreationDialog.value = false
}`,-1))],64))]),default:l(()=>[o(p(x),_({ref_key:"exCreateEventsVueCalEl",ref:F,"editable-events":{edit:!0,resize:!0,create:s.createMethod==="event-create",delete:!0}},{[ne(s.createMethod)]:s.createEvent},{events:s.events,"snap-to-interval":s.snapToInterval?15:0,"event-create-min-drag":s.eventCreateMinDrag?15:0,"time-from":540,"time-to":900,views:{days:{cols:5,rows:1}},view:"days","views-bar":!1,dark:p(E).darkMode}),null,16,["editable-events","events","snap-to-interval","event-create-min-drag","dark"]),s.newEvent?(i(),te(G,{key:0,modelValue:s.showCreationDialog,"onUpdate:modelValue":e[7]||(e[7]=a=>s.showCreationDialog=a),width:"300",onClose:s.cancel},{default:l(()=>[o(P,{modelValue:s.newEvent.title,"onUpdate:modelValue":e[4]||(e[4]=a=>s.newEvent.title=a)},{default:l(()=>e[61]||(e[61]=[n("Event Title",-1)])),_:1,__:[61]},8,["modelValue"]),o(P,{class:"my4",modelValue:s.newEvent.class,"onUpdate:modelValue":e[5]||(e[5]=a=>s.newEvent.class=a)},{default:l(()=>e[62]||(e[62]=[n("Event Class",-1)])),_:1,__:[62]},8,["modelValue"]),o(b,{modelValue:s.newEvent.background,"onUpdate:modelValue":e[6]||(e[6]=a=>s.newEvent.background=a)},{default:l(()=>e[63]||(e[63]=[n("Background",-1)])),_:1,__:[63]},8,["modelValue"]),t("div",he,[o(R,{onClick:s.cancel},{default:l(()=>e[64]||(e[64]=[n("Cancel",-1)])),_:1,__:[64]},8,["onClick"]),o(R,{onClick:s.save},{default:l(()=>e[65]||(e[65]=[n("OK",-1)])),_:1,__:[65]},8,["onClick"])])]),_:1},8,["modelValue","onClose"])):Y("",!0)]),_:1},512),o(z,{title:"Create Events Programmatically",anchor:"create-events-programmatically"},{desc:l(()=>[e[68]||(e[68]=t("p",{class:"my2"},[n(`In order to create events programmatically, from an external button for instance, you need to call
the vue-cal `),t("code",null,"view.createEvent()"),n(" function from a Vue ref.")],-1)),t("div",ke,[o(R,{sm:"",onClick:q.createEvent},{default:l(()=>[o(c,{class:"mr1"},{default:l(()=>e[66]||(e[66]=[n("mdi mdi-plus",-1)])),_:1,__:[66]}),e[67]||(e[67]=n("Create Event",-1))]),_:1,__:[67]},8,["onClick"])])]),"code-html":l(()=>e[69]||(e[69]=[n(`<button @click="createEvent">Create Event</button>
...
`),t("code",null,"editable-events"),n(" is provided as an object:")],-1)),o(A,{language:"js",dark:p(E).darkMode},{default:l(()=>e[71]||(e[71]=[n("{ drag: true, resize: true, delete: true, create: true }",-1)])),_:1,__:[71]},8,["dark"]),o(h,null,{default:l(()=>e[72]||(e[72]=[n(`In addition to the global settings, you can override the deletion ability individually for each
event using the event attributes `,-1),t("code",null,"deletable: false",-1),n(`.
`,-1)])),_:1,__:[72]}),e[80]||(e[80]=t("h4",{class:"mt4 mb0"},"B. Default Behavior & Flexibility",-1)),e[81]||(e[81]=t("p",null,[n("The deletion of an event is straightforward and extremely flexible."),t("br"),n(`
...
valid event you want.`),t("br")])],-1)),e[84]||(e[84]=t("h4",{class:"mt4 mb0"},"C. The Delete Function",-1)),t("div",null,[e[74]||(e[74]=n("Every event has a delete function that you can call from the event object itself:",-1)),o(A,{class:"d-iblock pr5 py0 ml1 mb0",language:"js",dark:p(E).darkMode},{default:l(()=>e[73]||(e[73]=[n("event.delete()",-1)])),_:1,__:[73]},8,["dark"])]),e[85]||(e[85]=t("p",null,`For more flexibility, this function can receive an explicit "deletion stage" integer parameter,
...
`,-1)])),_:1,__:[91]}),t("div",Ve,[o(b,{modelValue:m.creatable,"onUpdate:modelValue":e[14]||(e[14]=a=>m.creatable=a)},{default:l(()=>e[92]||(e[92]=[n("Create Events",-1)])),_:1,__:[92]},8,["modelValue"]),o(b,{modelValue:m.resizable,"onUpdate:modelValue":e[15]||(e[15]=a=>m.resizable=a)},{default:l(()=>e[93]||(e[93]=[n("Resize Events",-1)])),_:1,__:[93]},8,["modelValue"]),o(b,{modelValue:m.resizableX,"onUpdate:modelValue":e[16]||(e[16]=a=>m.resizableX=a)},{default:l(()=>e[94]||(e[94]=[n("Resize Events horizontally",-1)])),_:1,__:[94]},8,["modelValue"]),o(b,{modelValue:m.draggable,"onUpdate:modelValue":e[17]||(e[17]=a=>m.draggable=a)},{default:l(()=>e[95]||(e[95]=[n("Drag Events",-1)])),_:1,__:[95]},8,["modelValue"]),o(b,{modelValue:m.deletable,"onUpdate:modelValue":e[18]||(e[18]=a=>m.deletable=a)},{default:l(()=>e[96]||(e[96]=[n("Delete Events",-1)])),_:1,__:[96]},8,["modelValue"])])]),"code-html":l(()=>[n(`<vue-cal
...
will be lost.
`)],-1)])),_:1,__:[101]}),e[109]||(e[109]=t("p",{class:"mb2"},[n(`In this example, you can add or remove events from the array of events and they will be displayed in the
box below. You can also create events in the calendar with a click and drag, and resize or drag and drop
them.`),t("br"),n(`
The events in the list will accurately display the updated start and end times.`)],-1)),t("div",Te,[e[106]||(e[106]=t("div",{class:"title4"},"Current List of Events",-1)),t("div",Me,[o(R,{onClick:C.addEvent},{default:l(()=>[o(c,{class:"mr2"},{default:l(()=>e[102]||(e[102]=[n("mdi mdi-plus",-1)])),_:1,__:[102]}),e[103]||(e[103]=n("Add Event",-1))]),_:1,__:[103]},8,["onClick"]),o(R,{onClick:e[19]||(e[19]=a=>C.events.pop())},{default:l(()=>[o(c,{class:"mr2"},{default:l(()=>e[104]||(e[104]=[n("mdi mdi-trash-can-outline",-1)])),_:1,__:[104]}),e[105]||(e[105]=n("Remove Last Event",-1))]),_:1,__:[105]})])]),t("div",He,[C.events.length?Y("",!0):(i(),d("div",Re,e[107]||(e[107]=[t("div",{class:"caption"},"No events yet.",-1)]))),(i(!0),d(u,null,J(C.events,a=>(i(),d("div",Ie,[t("div",je,g(a.title),1),t("div",Oe,g(a.start.formatTime())+" - "+g(a.end.formatTime()),1)]))),256))])]),"code-html":l(()=>e[110]||(e[110]=[n(`<button
  @click="events.push({
    start: new Date(),
    end: new Date().addHours(1), // Using Vue Cal's Date prototypes.
    title: 'Event 1'
...
`)])],-1)),o(h,null,{default:l(()=>e[112]||(e[112]=[t("p",null,[n("If you listen for the "),t("code",null,"event-drop"),n(" event, you will receive an object with the following:")],-1),t("ul",null,[t("li",null,[t("code",null,"event"),n(": The event object that was dropped (contains the date and schedule where it was dropped).")]),t("li",null,[t("code",null,"cell"),n(": The cell object where the event was dropped.")]),t("li",null,[t("code",null,"e"),n(": The JavaScript native event object.")]),t("li",null,[t("code",null,"overlaps"),n(": An array of events that overlap the dropped event.")])],-1),t("p",null,[n("From the same event listener, you can "),t("strong",null,[n("reject the drop by returning "),t("code",null,"false")]),n(".")],-1)])),_:1,__:[112]}),t("div",Ue,[o(b,{modelValue:f.draggableEvents,"onUpdate:modelValue":e[23]||(e[23]=a=>f.draggableEvents=a),"label-color":"base"},{default:l(()=>e[113]||(e[113]=[n("Draggable Events",-1)])),_:1,__:[113]},8,["modelValue"]),o(N,{"align-right":""},{activator:l(({on:a})=>[t("div",U(a,!0),[o(b,{modelValue:f.overlappableEvents,"onUpdate:modelValue":e[24]||(e[24]=M=>f.overlappableEvents=M),"label-color":"base"},{default:l(()=>e[114]||(e[114]=[n("Overlappable Events",-1)])),_:1,__:[114]},8,["modelValue"])],16)]),default:l(()=>[e[115]||(e[115]=n("Allow dropping events on top of other events",-1))]),_:1,__:[115]}),o(N,{"align-right":""},{activator:l(({on:a})=>[t("div",U(a,!0),[o(b,{modelValue:f.snapToInterval,"onUpdate:modelValue":e[25]||(e[25]=M=>f.snapToInterval=M),"label-color":"base"},{default:l(()=>e[116]||(e[116]=[n("Snap to Interval",-1)])),_:1,__:[116]},8,["modelValue"])],16)]),default:l(()=>[e[117]||(e[117]=n("Snap the event to the closest round hour when dropped or resized",-1))]),_:1,__:[117]}),o(N,{"align-right":""},{activator:l(({on:a})=>[t("div",U(a,!0),[o(b,{modelValue:f.overrideDragCss,"onUpdate:modelValue":e[26]||(e[26]=M=>f.overrideDragCss=M),"label-color":"base"},{default:l(()=>e[118]||(e[118]=[n("Override Draggable CSS",-1)])),_:1,__:[118]},8,["modelValue"])],16)]),default:l(()=>[e[119]||(e[119]=n("Override the default event dragging CSS styles",-1))]),_:1,__:[119]})])]),"code-html":l(()=>[n(`<vue-cal
  :events="events"
...
Learn how in the example source code below!`)],-1)])),_:1,__:[126]}),e[128]||(e[128]=t("p",null,"In this example, you can drag the external events into the calendar and vice-versa.",-1))]),"code-html":l(()=>e[129]||(e[129]=[n(`<div
...
`,-1)),t("div",Fe,[o(b,{modelValue:y.preventOverlapOnDrop,"onUpdate:modelValue":e[29]||(e[29]=a=>y.preventOverlapOnDrop=a),"label-color":"base"},{default:l(()=>e[132]||(e[132]=[n("Prevent Event Overlap On Drop",-1)])),_:1,__:[132]},8,["modelValue"]),o(b,{modelValue:y.preventOverlapWhileResizing,"onUpdate:modelValue":e[30]||(e[30]=a=>y.preventOverlapWhileResizing=a),"label-color":"base"},{default:l(()=>e[133]||(e[133]=[n("Prevent Overlap WHILE Resizing",-1)])),_:1,__:[133]},8,["modelValue"]),o(b,{modelValue:y.preventOverlapAfterResizing,"onUpdate:modelValue":e[31]||(e[31]=a=>y.preventOverlapAfterResizing=a),"label-color":"base"},{default:l(()=>e[134]||(e[134]=[n("Prevent Overlap AFTER Resizing",-1)])),_:1,__:[134]},8,["modelValue"])])]),"code-html":l(()=>e[137]||(e[137]=[n(`<vue-cal
  :events="events"
  editable-events
  @event-drop="onEventDrop"
