...
`)])],-1)),n("div",q,[a(b,{modelValue:D.showBgEvents,"onUpdate:modelValue":e[0]||(e[0]=o=>D.showBgEvents=o)},{default:s(()=>e[25]||(e[25]=[t("Show Background Events")])),_:1},8,["modelValue"])])]),"code-html":s(()=>e[28]||(e[28]=[t('<vue-cal :events="events" />')])),"code-js":s(()=>[e[29]||(e[29]=t(`const events = [
  {
...
`)),D.showBgEvents?(r(),v("span",J,`  {
    start: new Date(new Date().setHours(12, 0, 0, 0)),
    end: new Date(new Date().setHours(14, 0, 0, 0)),
    class: 'lunch',
    background: true // Background event.
  },
`)):(r(),v("span",G)),e[30]||(e[30]=t(`  ...
...
.vuecal__event.lunch {
  background-color: repeating-linear-gradient(45deg, transparent 0 10px, `+i(d(f).darkMode?"#ffffff11":"#00000011")+` 10px 20px);
  border: none;
}`,1)]),default:s(()=>[a(d(E),{"time-from":9*60,"time-to":14*60,events:D.events,"onUpdate:events":e[1]||(e[1]=o=>D.events=o),views:{days:{cols:5,rows:1}},view:"days","views-bar":!1,dark:d(f).darkMode,style:{height:"261px"}},null,8,["events","dark"])]),_:1}),a(h,{title:"Timeless Events",anchor:"timeless-events"},{desc:s(()=>e[31]||(e[31]=[n("p",null,[t("When "),n("code",null,"time"),t(" is set to "),n("code",null,"false"),t(`, the calendar and the events are timeless. The events can't be
resized.`)],-1)])),"code-html":s(()=>e[32]||(e[32]=[t('<vue-cal :time="false" :events="events" />')])),"code-js":s(()=>e[33]||(e[33]=[t(`const events = [
  {
    start: new Date(),
    end: new Date(),
  ...
  ...
]`)])),default:s(()=>[a(d(E),{dark:d(f).darkMode,time:!1,views:{days:{cols:5,rows:1}},view:"days","views-bar":!1,events:B.events},null,8,["dark","events"])]),_:1}),a(h,{title:"Open a Dialog on Event Click",anchor:"open-dialog-on-event-click"},{desc:s(()=>e[34]||(e[34]=[n("p",{class:"mb2"},[t(`You can attach whatever event listener you want to the events: it only needs to start with
...
</w-dialog>`)])),"code-js":s(()=>e[36]||(e[36]=[t(`const showDialog = ref(false)
...
`)])),default:s(()=>[a(d(E),{class:"ex--open-dialog-on-event-click",events:c.events,"time-from":9*60,"time-to":15*60,views:{days:{cols:5,rows:1}},view:"days","views-bar":!1,dark:d(f).darkMode,onEventClick:c.openDialog},null,8,["events","dark","onEventClick"])]),_:1}),c.event?(r(),N(M,{key:0,modelValue:c.showDialog,"onUpdate:modelValue":e[2]||(e[2]=o=>c.showDialog=o),title:c.event.title,width:"380"},{default:s(()=>[n("div",I,[a(O,{class:"grey"},{default:s(()=>e[37]||(e[37]=[t("mdi mdi-calendar")])),_:1}),n("small",null,i(c.event.start.format()),1),a(O,{class:"grey ml2"},{default:s(()=>e[38]||(e[38]=[t("mdi mdi-clock-outline")])),_:1}),n("small",null,i(c.event.start.formatTime())+" - "+i(c.event.end.formatTime()),1)]),n("div",{class:"w-flex align-center justify-center title1 mt6 mb4",innerHTML:c.event.content},null,8,L),e[39]||(e[39]=n("p",{class:"lh1"},`Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil inventore expedita veniam deleniti,
labore corporis quas, aspernatur praesentium quia nisi, omnis quod autem.
`,-1))]),_:1},8,["modelValue","title"])):A("",!0),a(h,{title:"Month View Events & Count",anchor:"events-on-month-view"},{desc:s(()=>[n("ul",null,[e[43]||(e[43]=n("li",null,[t("When "),n("code",null,"events-on-month-view"),t(` is set to true, the events will show in full on the month view
...
`)),a(j,{to:"/examples/customization#ex--events-on-month-view"},{default:s(()=>e[40]||(e[40]=[t("Events on Month View Customization")])),_:1}),e[42]||(e[42]=t(`.
`))])]),n("div",$,[a(b,{modelValue:l.showEvents,"onUpdate:modelValue":[e[3]||(e[3]=o=>l.showEvents=o),e[4]||(e[4]=o=>l.showEvents&&(l.showEventCount=!1))],"label-on-left":""},{default:s(()=>e[46]||(e[46]=[t("Show Events")])),_:1},8,["modelValue"]),a(b,{modelValue:l.showEventCount,"onUpdate:modelValue":[e[5]||(e[5]=o=>l.showEventCount=o),e[6]||(e[6]=o=>l.showEventCount&&(l.showEvents=!1))],"label-on-left":""},{default:s(()=>e[47]||(e[47]=[t("Show Event Count")])),_:1},8,["modelValue"]),a(T,{modelValue:l.eventCountStyle,"onUpdate:modelValue":e[7]||(e[7]=o=>l.eventCountStyle=o),inline:"",items:l.eventCountStyleOptions,disabled:!l.showEventCount},{default:s(()=>e[48]||(e[48]=[t("Events Count Style")])),_:1},8,["modelValue","items","disabled"]),e[50]||(e[50]=n("p",{class:"caption"},"For illustration, the slot option will only count orange events (with the `leisure` class).",-1)),a(b,{modelValue:l.highlightCells,"onUpdate:modelValue":e[8]||(e[8]=o=>l.highlightCells=o),"label-on-left":""},{default:s(()=>e[49]||(e[49]=[t("Highlight Cells with Events")])),_:1},8,["modelValue"])])]),"code-html":s(()=>[t(`<vue-cal
...
`,1),l.showEventCount&&l.eventCountStyle==="slot"?(r(),v(p,{key:0},[t(`
...
`)),l.showEventCount?l.eventCountStyle==="dot"?(r(),v(p,{key:1},[t(`  .event-count--dot .vuecal__cell-events-count {
    position: absolute;
    bottom: 14px;
    right: 15%;
...
`)],64)):l.eventCountStyle==="dash"?(r(),v(p,{key:2},[t(`  .event-count--dash .vuecal__cell-events-count {
    position: absolute;
    top: 24px;
    right: 12px;
    text-align: center;
...
`)],64)):l.eventCountStyle==="caption"?(r(),v(p,{key:3},[t(`  .event-count--caption .vuecal__cell-events-count {
    position: absolute;
    inset: auto 2px 2px;
    text-align: center;
    opacity: 0.3;
...
`)],64)):(r(),v(p,{key:4},[],64)):(r(),v(p,{key:0},[],64)),l.highlightCells?(r(),v(p,{key:5},[t("  .vuecal__cell--has-events {background-color: "+i(d(f).darkMode?"#00dbff1c":"#fffacda8")+`;}
`,1)],64)):(r(),v(p,{key:6},[],64)),e[52]||(e[52]=t("}"))]),default:s(()=>[a(d(E),{events:C,"events-on-month-view":l.showEvents,"event-count":l.showEventCount,"time-from":8*60,"time-to":18*60,views:{days:{cols:5,rows:1},month:{},year:{}},view:"month",dark:d(f).darkMode,class:W(l.classes),style:{height:"506px"}},F({_:2},[l.showEventCount&&l.eventCountStyle==="slot"?{name:"event-count",fn:s(({events:o})=>[o.filter(H=>H.class==="leisure").length?(r(),v("span",R,i(o.filter(H=>H.class==="leisure").length),1)):A("",!0)]),key:"0"}:void 0]),1032,["events-on-month-view","event-count","dark","class"])]),_:1}),a(h,{title:"Overlapping Events",anchor:"overlapping-events"},{desc:s(()=>[e[55]||(e[55]=n("p",null,[t("Overlapping, editable & deletable events."),n("br"),t(`
...
`)],-1)),a(x,{tip:""},{default:s(()=>[e[53]||(e[53]=n("div",{class:"mb2"},[t(`Alternatively, you can use the event stacking class (based on the stack position and length) to override
the default stacking behavior to your liking via CSS (you will need to use `),n("code",null,"!important"),t(")."),n("br"),t(`
Example of classes for three overlapping events: `),n("code",null,"vuecal__event--stack-1-3"),t(", "),n("code",null,"vuecal__event--stack-2-3"),t(", "),n("code",null,"vuecal__event--stack-3-3"),t(".")],-1)),a(U,{src:"/images/calendar-events-display-overlapping-events.webp",lazy:"","aspect-ratio":1076/336,"max-width":"500px"})]),_:1}),n("div",Y,[a(b,{modelValue:k.stackEvents,"onUpdate:modelValue":e[9]||(e[9]=o=>k.stackEvents=o),"label-on-left":""},{default:s(()=>e[54]||(e[54]=[t("Stack Events")])),_:1},8,["modelValue"])])]),"code-html":s(()=>[t(`<vue-cal
...
`)])),default:s(()=>[a(d(E),{events:k.events,"editable-events":"","stack-events":k.stackEvents,"min-event-width":k.minEventWidth,views:{days:{cols:5,rows:1}},view:"days","views-bar":!1,"time-from":9*60,"time-to":15*60,dark:d(f).darkMode},null,8,["events","stack-events","min-event-width","dark"])]),_:1}),a(h,{title:"All Day Events",anchor:"all-day-events"},{desc:s(()=>[e[59]||(e[59]=n("p",null,[t(`All-day events are events that span the whole day (from 00:00 to 23:59:59:999). They will be displayed in a fixed top bar
...
`)],-1)),n("div",K,[a(b,{modelValue:m.allDayBarOn,"onUpdate:modelValue":e[10]||(e[10]=o=>m.allDayBarOn=o),"label-on-left":""},{default:s(()=>e[57]||(e[57]=[t("Show All-day Bar")])),_:1},8,["modelValue"]),a(b,{modelValue:m.allDayEventsOn,"onUpdate:modelValue":e[11]||(e[11]=o=>m.allDayEventsOn=o),"label-on-left":""},{default:s(()=>e[58]||(e[58]=[t("Switch on all "),n("code",{class:"ml1"},"event.allDay",-1)])),_:1},8,["modelValue"])])]),"code-html":s(()=>[t(`<vue-cal
...
const events = [
  ...
  ...
]`,1)]),"code-css":s(()=>e[62]||(e[62]=[t(`.vuecal__cell-content {align-self: flex-start;}
...
`)])),default:s(()=>[a(d(E),{"time-from":7*60,view:"days",views:{day:{},days:{cols:5,rows:1},week:{},month:{}},"all-day-events":m.allDayBarOn,events:m.events,dark:d(f).darkMode},null,8,["all-day-events","events","dark"])]),_:1}),a(h,{title:"Multiple Day Events",anchor:"multiple-day-events"},{title:s(()=>e[63]||(e[63]=[t("Multiple Day Events"),n("div",{class:"todo-tag prod d-iflex ml2"},"COMING SOON",-1)])),_:1}),a(h,{anchor:"recurring-events"},{title:s(()=>e[64]||(e[64]=[t("Recurring Events"),n("div",{class:"todo-tag prod d-iflex ml2"},"COMING SOON",-1)])),_:1})],64)}}};export{_ as default};
