...
`)])],-1)),o(H,{class:"bd1 bdrs2 sh2",src:`${Y.value}images/click-and-drag.webp`,alt:"Create Events",width:"250",lazy:""},null,8,["src"])]),o(h,null,{default:l(()=>[...e[52]||(e[52]=[n("The event creation is only available on a day cell: not on year & years views.",-1)])]),_:1}),t("div",be,[e[54]||(e[54]=t("label",null,"Create Event On Cell",-1)),t("div",null,[o(j,{modelValue:s.createMethod,"onUpdate:modelValue":[e[0]||(e[0]=a=>s.createMethod=a),(U.value||{}).refreshHeight],items:s.createMethods},null,8,["modelValue","onUpdate:modelValue","items"]),e[53]||(e[53]=t("p",{class:"caption mt1"},"(Or however you want)",-1))])]),t("div",De,[o(b,{modelValue:s.skipCreationDialog,"onUpdate:modelValue":[e[1]||(e[1]=a=>s.skipCreationDialog=a),(U.value||{}).refreshHeight]},{default:l(()=>[...e[55]||(e[55]=[n("Skip Creation Dialog",-1)])]),_:1},8,["modelValue","onUpdate:modelValue"]),o(b,{modelValue:s.snapToInterval,"onUpdate:modelValue":e[2]||(e[2]=a=>s.snapToInterval=a)},{default:l(()=>[...e[56]||(e[56]=[n("Snap to Interval: ",-1),t("span",{class:"code transparent--bg inherit"},"15min",-1)])]),_:1},8,["modelValue"]),o(b,{modelValue:s.eventCreateMinDrag,"onUpdate:modelValue":e[3]||(e[3]=a=>s.eventCreateMinDrag=a)},{default:l(()=>[...e[57]||(e[57]=[n("Event Create Drag Min: ",-1),t("span",{class:"code transparent--bg inherit"},"15px",-1)])]),_:1},8,["modelValue"])])]),"code-html":l(()=>[n(`<vue-cal
...
const validateCreation = () => {`,-1)),s.createMethod!=="event-create"?(i(),d(u,{key:4},[n(`
  ...
  showCreationDialog.value = false
}`,-1))],64))]),default:l(()=>[o(p(x),P({"editable-events":{edit:!0,resize:!0,create:s.createMethod==="event-create",delete:!0}},{[_(s.createMethod)]:s.createEvent},{events:s.events,"snap-to-interval":s.snapToInterval?15:0,"event-create-min-drag":s.eventCreateMinDrag?15:0,"time-from":540,"time-to":900,views:{days:{cols:5,rows:1}},view:"days","views-bar":!1,dark:p(E).darkMode}),null,16,["editable-events","events","snap-to-interval","event-create-min-drag","dark"]),s.newEvent?(i(),ee(K,{key:0,modelValue:s.showCreationDialog,"onUpdate:modelValue":e[7]||(e[7]=a=>s.showCreationDialog=a),width:"300",onClose:s.cancel},{default:l(()=>[o(W,{modelValue:s.newEvent.title,"onUpdate:modelValue":e[4]||(e[4]=a=>s.newEvent.title=a)},{default:l(()=>[...e[63]||(e[63]=[n("Event Title",-1)])]),_:1},8,["modelValue"]),o(W,{class:"my4",modelValue:s.newEvent.class,"onUpdate:modelValue":e[5]||(e[5]=a=>s.newEvent.class=a)},{default:l(()=>[...e[64]||(e[64]=[n("Event Class",-1)])]),_:1},8,["modelValue"]),o(b,{modelValue:s.newEvent.background,"onUpdate:modelValue":e[6]||(e[6]=a=>s.newEvent.background=a)},{default:l(()=>[...e[65]||(e[65]=[n("Background",-1)])]),_:1},8,["modelValue"]),t("div",Ee,[o(R,{onClick:s.cancel},{default:l(()=>[...e[66]||(e[66]=[n("Cancel",-1)])]),_:1},8,["onClick"]),o(R,{onClick:s.save},{default:l(()=>[...e[67]||(e[67]=[n("OK",-1)])]),_:1},8,["onClick"])])]),_:1},8,["modelValue","onClose"])):O("",!0)]),_:1},512),o(z,{title:"Create Events Programmatically",anchor:"create-events-programmatically"},{desc:l(()=>[e[70]||(e[70]=t("p",{class:"my2"},[n(`In order to create events programmatically, from an external button for instance, you need to call
the vue-cal `),t("code",null,"view.createEvent()"),n(" function from a Vue ref.")],-1)),t("div",he,[o(R,{sm:"",onClick:J.createEvent},{default:l(()=>[o(m,{class:"mr1"},{default:l(()=>[...e[68]||(e[68]=[n("mdi mdi-plus",-1)])]),_:1}),e[69]||(e[69]=n("Create Event",-1))]),_:1},8,["onClick"])])]),"code-html":l(()=>[...e[71]||(e[71]=[n(`<button @click="createEvent">Create Event</button>
...
}`,-1)])]),default:l(()=>[o(p(x),{ref_key:"exExternalEventCreateVuecalRef",ref:N,"editable-events":"",onReady:e[8]||(e[8]=({view:a})=>a.scrollToCurrentTime()),onEventCreated:e[9]||(e[9]=a=>a._.$el.scrollIntoView({behavior:"smooth",block:"center",inline:"nearest"})),views:{days:{cols:5,rows:1}},view:"days","views-bar":!1,dark:p(E).darkMode},null,8,["dark"])]),_:1}),o(z,{title:"Delete Events",anchor:"delete-events"},{desc:l(()=>[e[80]||(e[80]=t("h4",{class:"mt4 mb0"},"A. Deletion Rules",-1)),e[81]||(e[81]=t("p",{class:"mb2"},[n("The deletion of events is allowed or denied when the "),t("code",null,"editable-events"),n(` option is set to
`),t("code",null,"true"),n(" or "),t("code",null,"false"),n(" - or more granularly "),t("code",null,"editable-events.delete"),n(`, when
`),t("code",null,"editable-events"),n(" is provided as an object:")],-1)),o(B,{language:"js",dark:p(E).darkMode},{default:l(()=>[...e[73]||(e[73]=[n("{ drag: true, resize: true, delete: true, create: true }",-1)])]),_:1},8,["dark"]),o(h,null,{default:l(()=>[...e[74]||(e[74]=[n(`In addition to the global settings, you can override the deletion ability individually for each
...
valid event you want.`),t("br")])],-1)),e[86]||(e[86]=t("h4",{class:"mt4 mb0"},"C. The Delete Function",-1)),t("div",null,[e[76]||(e[76]=n("Every event has a delete function that you can call from the event object itself:",-1)),o(B,{class:"d-iblock pr5 py0 ml1 mb0",language:"js",dark:p(E).darkMode},{default:l(()=>[...e[75]||(e[75]=[n("event.delete()",-1)])]),_:1},8,["dark"])]),e[87]||(e[87]=t("p",null,`For more flexibility, this function can receive an explicit "deletion stage" integer parameter,
...
`,-1)])]),default:l(()=>[o(p(x),{ref_key:"exEditEventsVuecalRef",ref:F,"editable-events":{create:c.creatable,resize:c.resizable,resizeX:c.resizableX,drag:c.draggable,delete:c.deletable},events:c.events,"time-from":540,"time-to":900,views:{days:{cols:5,rows:1}},view:"days","views-bar":!1,dark:p(E).darkMode},{event:l(({event:a})=>[t("strong",null,g(a.title),1),t("p",null,g(a.start.formatTime())+" - "+g(a.end.formatTime()),1),t("p",{innerHTML:a.content},null,8,Ve)]),_:1},8,["editable-events","events","dark"])]),_:1}),o(z,{title:"Events v-model",anchor:"events-v-model"},{desc:l(()=>[e[110]||(e[110]=t("p",null,[n(`The good news is that the events prop is a two-way binding! So you can use it to read or write with
...
`,-1)])]),default:l(()=>[t("div",Ue,[t("div",{class:"external-events w-flex column gap2",onDrop:e[27]||(e[27]=(...a)=>V.onEventDropInBank&&V.onEventDropInBank(...a)),onDragover:e[28]||(e[28]=ae(()=>{},["prevent"]))},[e[130]||(e[130]=t("div",{class:"title4 primary text-center"},"Ext. Events",-1)),(i(!0),d(u,null,X(V.events,(a,q)=>(i(),d("div",{class:"external-event",key:q,draggable:"true",onDragstart:G=>V.onEventDragStart(G,a)},[t("strong",Be,g(a.title),1),t("div",Ae,"("+g((a._||{}).duration||a.duration?`${(a._||{}).duration||a.duration} min`:"no duration")+")",1)],40,Se))),128))],32),o(p(x),{class:"grow",ref_key:"exExternalEventsDragDropEl1",ref:S,onEventDrop:V.onEventDrop,"editable-events":"","views-bar":!1,views:{days:{cols:3,rows:1}},view:"days","time-from":540,"time-to":900,"today-button":!1,dark:p(E).darkMode},null,8,["onEventDrop","dark"]),o(p(x),{class:"grow",ref_key:"exExternalEventsDragDropEl2",ref:L,onEventDrop:V.onEventDrop,"editable-events":"","views-bar":!1,views:{days:{cols:3,rows:1}},view:"days","time-from":540,"time-to":900,"today-button":!1,dark:p(E).darkMode},null,8,["onEventDrop","dark"])])]),_:1}),o(z,{title:"Reject Event Drag & Drop or Resizing",anchor:"reject-event-dnd-or-resizing"},{desc:l(()=>[e[134]||(e[134]=t("p",null,[n("The drag & drop and resizing of events can be rejected by returning "),t("code",null,"false"),n(` from the
