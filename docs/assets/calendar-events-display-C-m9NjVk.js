...
`)])],-1)),n("div",z,[o(C,{modelValue:p.showBgEvents,"onUpdate:modelValue":e[0]||(e[0]=a=>p.showBgEvents=a)},{default:s(()=>e[23]||(e[23]=[t("Show Background Events")])),_:1},8,["modelValue"])])]),"code-html":s(()=>e[26]||(e[26]=[t('<vue-cal :events="events" />')])),"code-js":s(()=>[e[27]||(e[27]=t(`const events = [
  {
