...
`,-1)])),default:s(()=>[t("div",J,[a(m(x),{dark:m(E).darkMode,"time-from":540,"time-to":1080,"views-bar":!1,events:u.events,onReady:u.onReady,onViewChange:u.onViewChange,style:{height:"421px"}},null,8,["dark","events","onReady","onViewChange"]),u.loading?(b(),P(T,{key:0,class:"mt-1"})):L("",!0),t("div",G,[u.loading?(b(),D(V,{key:0},[l("Loading events...")],64)):(b(),D(V,{key:1},[l(f(u.eventsTotal)+" events loaded.",1)],64))])])]),_:1}),a(y,{title:"External Controls & use of Vue Cal Methods",anchor:"external-controls"},{desc:s(()=>[e[76]||(e[76]=t("p",null,[l("You can access any "),t("strong",null,"Vue Cal"),l(" internal method through Vue refs."),t("br"),l(`
