...
`)])),_:1}),a(y,{title:"Loading Events from a Backend",anchor:"loading-events-from-backend"},{desc:s(()=>e[57]||(e[57]=[t("p",null,[l(`Vue Cal can easily load events from a backend service whenever the view changes.
...
`)])),default:s(()=>[t("div",G,[a(m(x),{dark:m(E).darkMode,"time-from":9*60,"time-to":18*60,"views-bar":!1,events:u.events,onReady:u.onReady,onViewChange:u.onViewChange,style:{height:"421px"}},null,8,["dark","events","onReady","onViewChange"]),u.loading?(b(),P(T,{key:0,class:"mt-1"})):L("",!0),t("div",J,[u.loading?(b(),D(V,{key:0},[l("Loading events...")],64)):(b(),D(V,{key:1},[l(f(u.eventsTotal)+" events loaded.",1)],64))])])]),_:1}),a(y,{title:"External Controls & use of Vue Cal Methods",anchor:"external-controls"},{desc:s(()=>[e[76]||(e[76]=t("p",null,[l("You can access any "),t("strong",null,"Vue Cal"),l(" internal method through Vue refs."),t("br"),l(`
...
`)],-1)])),_:1})]),_:1}),a(y,{title:"Sync Two Vue Cal Instances",anchor:"sync-two-calendars"},{desc:s(()=>e[81]||(e[81]=[t("p",null,[l(`In this example the right calendar is used as a date picker and the selected date is
