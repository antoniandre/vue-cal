...
`)])),_:1}),t("div",ke,[o(b,{modelValue:w.creatable,"onUpdate:modelValue":e[14]||(e[14]=a=>w.creatable=a)},{default:l(()=>e[91]||(e[91]=[n("Create Events")])),_:1},8,["modelValue"]),o(b,{modelValue:w.resizable,"onUpdate:modelValue":e[15]||(e[15]=a=>w.resizable=a)},{default:l(()=>e[92]||(e[92]=[n("Resize Events")])),_:1},8,["modelValue"]),o(b,{modelValue:w.draggable,"onUpdate:modelValue":e[16]||(e[16]=a=>w.draggable=a)},{default:l(()=>e[93]||(e[93]=[n("Drag Events")])),_:1},8,["modelValue"]),o(b,{modelValue:w.deletable,"onUpdate:modelValue":e[17]||(e[17]=a=>w.deletable=a)},{default:l(()=>e[94]||(e[94]=[n("Delete Events")])),_:1},8,["modelValue"])])]),"code-html":l(()=>[n(`<vue-cal
  :editable-events="{ create: `+p(w.creatable?"true":"false")+", resize: "+p(w.resizable?"true":"false")+",  drag: "+p(w.draggable?"true":"false")+", delete: "+p(w.deletable?"true":"false")+` }"
  :events="events">
...
`)])),default:l(()=>[o(g(V),{ref_key:"exEditEventsVuecalRef",ref:L,"editable-events":{create:w.creatable,resize:w.resizable,drag:w.draggable,delete:w.deletable},events:w.events,"time-from":9*60,"time-to":15*60,views:{days:{cols:5,rows:1}},view:"days","views-bar":!1,dark:g(h).darkMode,style:{height:"301px"}},{event:l(({event:a})=>[t("strong",null,p(a.title),1),t("p",null,p(a.start.formatTime())+" - "+p(a.end.formatTime()),1),t("p",{innerHTML:a.content},null,8,xe)]),_:1},8,["editable-events","events","dark"])]),_:1}),o(T,{title:"Events v-model",anchor:"events-v-model"},{desc:l(()=>[e[106]||(e[106]=t("p",null,[n(`The good news is that the events prop is a two-way binding! So you can use it to read or write with
...
them.`),t("br"),n(`
The events in the list will accurately display the updated start and end times.`)],-1)),t("div",Ce,[e[104]||(e[104]=t("div",{class:"title4"},"Current List of Events",-1)),t("div",Ve,[o(H,{onClick:x.addEvent},{default:l(()=>[o(m,{class:"mr2"},{default:l(()=>e[100]||(e[100]=[n("mdi mdi-plus")])),_:1}),e[101]||(e[101]=n("Add Event"))]),_:1},8,["onClick"]),o(H,{onClick:e[18]||(e[18]=a=>x.events.pop())},{default:l(()=>[o(m,{class:"mr2"},{default:l(()=>e[102]||(e[102]=[n("mdi mdi-trash-can-outline")])),_:1}),e[103]||(e[103]=n("Remove Last Event"))]),_:1})])]),t("div",Te,[x.events.length?$("",!0):(i(),d("div",ze,e[105]||(e[105]=[t("div",{class:"caption"},"No events yet.",-1)]))),(i(!0),d(u,null,J(x.events,a=>(i(),d("div",Me,[t("div",He,p(a.title),1),t("div",Re,p(a.start.formatTime())+" - "+p(a.end.formatTime()),1)]))),256))])]),"code-html":l(()=>e[108]||(e[108]=[n(`<button
  @click="events.push({
    start: new Date(),
    end: new Date().addHours(1), // Using Vue Cal's Date prototypes.
    title: 'Event 1'
...
<vue-cal v-model:events="events" />`)])),"code-js":l(()=>e[109]||(e[109]=[n(`const events = [
  ...
  ...
]`)])),default:l(()=>[o(g(V),{ref:"exEventsVModelVuecalRef",events:x.events,"onUpdate:events":e[19]||(e[19]=a=>x.events=a),"editable-events":"",onReady:e[20]||(e[20]=({view:a})=>a.scrollToCurrentTime()),onEventCreate:x.onEventCreate,onEventDblclick:e[21]||(e[21]=({event:a})=>a.delete(2)),views:{days:{cols:5,rows:1}},view:"days","views-bar":!1,dark:g(h).darkMode,style:{height:"301px"}},null,8,["events","onEventCreate","editable-events","dark"])]),_:1}),o(T,{title:"Event Drag & Drop",anchor:"drag-and-drop"},ee({desc:l(()=>[e[118]||(e[118]=t("div",{class:"todo-tag d-iflex"},"FINISH THIS EXAMPLE - DISABLE A DAY",-1)),e[119]||(e[119]=t("p",null,[n(`The drag & drop functionality is available for single-day foreground events only and is powered by
...
`)])],-1)),o(E,null,{default:l(()=>e[110]||(e[110]=[t("p",null,[n("If you listen for the "),t("code",null,"event-drop"),n(" event, you will receive an object with the following:")],-1),t("ul",null,[t("li",null,[t("code",null,"event"),n(": The event object that was dropped (contains the date and schedule where it was dropped).")]),t("li",null,[t("code",null,"cell"),n(": The cell object where the event was dropped.")]),t("li",null,[t("code",null,"e"),n(": The JavaScript native event object.")]),t("li",null,[t("code",null,"overlaps"),n(": An array of events that overlap the dropped event.")])],-1),t("p",null,[n("From the same event listener, you can "),t("strong",null,[n("reject the drop by returning "),t("code",null,"false")]),n(".")],-1)])),_:1}),t("div",Ie,[o(b,{modelValue:f.draggableEvents,"onUpdate:modelValue":e[22]||(e[22]=a=>f.draggableEvents=a),"label-color":"base"},{default:l(()=>e[111]||(e[111]=[n("Draggable Events")])),_:1},8,["modelValue"]),o(A,{"align-right":""},{activator:l(({on:a})=>[t("div",j(a,!0),[o(b,{modelValue:f.overlappableEvents,"onUpdate:modelValue":e[23]||(e[23]=M=>f.overlappableEvents=M),"label-color":"base"},{default:l(()=>e[112]||(e[112]=[n("Overlappable Events")])),_:1},8,["modelValue"])],16)]),default:l(()=>[e[113]||(e[113]=n("Allow dropping events on top of other events"))]),_:1}),o(A,{"align-right":""},{activator:l(({on:a})=>[t("div",j(a,!0),[o(b,{modelValue:f.snapToInterval,"onUpdate:modelValue":e[24]||(e[24]=M=>f.snapToInterval=M),"label-color":"base"},{default:l(()=>e[114]||(e[114]=[n("Snap to Interval")])),_:1},8,["modelValue"])],16)]),default:l(()=>[e[115]||(e[115]=n("Snap the event to the closest round hour when dropped or resized"))]),_:1}),o(A,{"align-right":""},{activator:l(({on:a})=>[t("div",j(a,!0),[o(b,{modelValue:f.overrideDragCss,"onUpdate:modelValue":e[25]||(e[25]=M=>f.overrideDragCss=M),"label-color":"base"},{default:l(()=>e[116]||(e[116]=[n("Override Draggable CSS")])),_:1},8,["modelValue"])],16)]),default:l(()=>[e[117]||(e[117]=n("Override the default event dragging CSS styles"))]),_:1})])]),"code-html":l(()=>[n(`<vue-cal
  :events="events"
  :editable-events="{ drag: `+p(f.draggableEvents?"true":"false")+` }"
  `+p(f.snapToInterval?`:snap-to-interval="60"
  `:"")+`@event-drop="onEventDrop"
  :schedules="schedules">
</vue-cal>`,1)]),"code-js":l(()=>[e[122]||(e[122]=n(`const schedules = [{ id: 1, label: 'Dr 1' }, { id: 2, label: 'Dr 2' }]
`)),f.overlappableEvents?(i(),d(u,{key:0},[n(`
...
`)],64))]),default:l(()=>[o(g(V),{events:f.events,"editable-events":{drag:f.draggableEvents},onEventDrop:f.onEventDrop,schedules:[{id:1,label:"Dr 1"},{id:2,label:"Dr 2"}],"time-from":9*60,"time-to":15*60,"snap-to-interval":f.snapToInterval?60:0,views:{days:{cols:5,rows:1}},view:"days","views-bar":!1,dark:g(h).darkMode,class:te({"override-drag-css":f.overrideDragCss}),style:{height:"312px"}},null,8,["events","editable-events","onEventDrop","snap-to-interval","dark","class"])]),_:2},[f.overrideDragCss?{name:"code-css",fn:l(()=>[e[123]||(e[123]=n(`.vuecal__event--dragging-ghost {
  opacity: 1;
...
`)])),default:l(()=>[t("div",Oe,[t("div",{class:"external-events w-flex column gap2",onDrop:e[26]||(e[26]=(...a)=>C.onEventDropInBank&&C.onEventDropInBank(...a)),onDragover:e[27]||(e[27]=ne(()=>{},["prevent"]))},[e[129]||(e[129]=t("div",{class:"title4 primary text-center"},"Ext. Events",-1)),(i(!0),d(u,null,J(C.events,(a,M)=>(i(),d("div",{class:"external-event",key:M,draggable:"true",onDragstart:G=>C.onEventDragStart(G,a)},[t("strong",Se,p(a.title),1),t("div",Ue,"("+p((a._||{}).duration||a.duration?`${(a._||{}).duration||a.duration} min`:"no duration")+")",1)],40,je))),128))],32),o(g(V),{class:"grow",ref_key:"exExternalEventsDragDropEl1",ref:U,onEventDrop:C.onEventDrop,"editable-events":"","views-bar":!1,views:{days:{cols:3,rows:1}},view:"days","time-from":9*60,"time-to":15*60,small:"","today-button":!1,dark:g(h).darkMode,style:{height:"301px"}},null,8,["onEventDrop","dark"]),o(g(V),{class:"grow",ref_key:"exExternalEventsDragDropEl2",ref:W,onEventDrop:C.onEventDrop,"editable-events":"","views-bar":!1,views:{days:{cols:3,rows:1}},view:"days","time-from":9*60,"time-to":15*60,small:"","today-button":!1,dark:g(h).darkMode,style:{height:"301px"}},null,8,["onEventDrop","dark"])])]),_:1}),o(T,{title:"Reject Event Drag & Drop or Resizing",anchor:"reject-event-dnd-or-resizing"},{desc:l(()=>[e[133]||(e[133]=t("p",null,[n("The drag & drop and resizing of events can be rejected by returning "),t("code",null,"false"),n(` from the
