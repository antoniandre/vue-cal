<template lang="pug">
.documentation
  highlight-message.pa-8(type="error" no-icon)
    h2.headline.mb-3.title This is the V1 documentation
    strong As vue-cal version 1 is now long outdated, this documentation will be removed as of February 15th, 2020.
