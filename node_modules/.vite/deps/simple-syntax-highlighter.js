import {
  ...
  renderSlot,
  useSlots
} from "./chunk-HVUBFZF7.js";

// node_modules/.pnpm/simple-syntax-highlighter@3.0.10_vue@3.5.8/node_modules/simple-syntax-highlighter/dist/sshpre.es.js
var Y = ["data-type", "data-label"];
var X = ["contenteditable"];
var Q = { class: "ssh-pre__original" };
var Z = {
  ...
  setup(p, { emit: O }) {
    const o = {
      ...
      css: { quote: 2 },
      js: { quote: 2 }
    }, c = p, D = O, T = ref(Object.keys(b)), u = ref(null), v = useSlots(), E = (t) => t.map((e) => {
...
<span class="text">${m}</span>`;
    ...
    return onMounted(() => {
      ...
      class: normalizeClass(["ssh-pre", { "ssh-pre--dark": p.dark }]),
      "data-type": p.language,
      "data-label": p.label || null
    }, [
      p.copyButton ? (openBlock(), createElementBlock("button", {
        key: 0,
        class: "ssh-pre__copy",
        onClick: H
      }, [
        renderSlot(t.$slots, "copy-button", {}, () => [
